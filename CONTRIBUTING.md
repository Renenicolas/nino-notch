...
You can contribute in many ways: writing code, improving documentation, reporting bugs, requesting features, or creating tutorials and blog posts. Every contribution, large or small, helps make Nino Notch better.
...
Localization files live in `boringNotch/Localizable.xcstrings`. Edit them in Xcode and open a pull request; this fork is not connected to the upstream Crowdin project.
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/{your-username}/nino-notch.git
   cd nino-notch
   ```
...
Thank you for contributing to Nino Notch! Your efforts help make this project better for everyone. 🎉
